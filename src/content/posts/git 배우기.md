...
git 기본이랑 HEAD 분리하기까지는 그래도 금방 풀었는데, Cherry-pick 부터 살짝 막히기 시작했다. Cherry-pick은 이름부터 뭔가 있어 보여서 어렵겠다 했는데 역시나 개념 자체는 이해가 됐는데 실제로 커밋 해시 골라서 쓰는 게 좀 헷갈렸다.
...
아직 고급 파트는 다 못 풀었고 원격도 절반 정도 왔는데, 일단 개념이 눈에 보이기 시작하는 느낌이라 좀 재밌어지긴 했다. 게임처럼 만들어놔서 그런지 질리지 않고 할 수 있는 것 같다.
